// <div class="project 11 grid__col--6">
//   <h3>React Gallery</h3>
//   <img class="img--frame" src="img/projects/project-11.png " alt="React Gallery image"/>
//   <p>React is a JavaScript library for building user interfaces. It's fast, easy and manageable.
//      For first time it's a pain in some lower body part. In this project I'm using Flickrs API and displaying photo via search or by pushing the buttons.</p>
//   <h4>Skills</h4>
//   <ul class="grid__col--12 ">
//     <li class="skills-html ">HTML</li>
//     <li class="skills-css ">CSS</li>
//     <li class="skills-js ">JS</li>
//     <li class="skills-react ">React</li>
//   </ul>
